...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/common.css?v7.2" />
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/public.css?v1" />
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/jq.js?v4.1"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/ss.js?v4.8"></script>
...
<div class="pb-container">
    <div class="pb-container-main pb-after-clear">
        ...
        <!-- 公共头部 -->
        <!-- 当前页面内容 -->
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/jquery.slideBox.css" />
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/index.css?v2" />
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.slideBox.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/js/ap.js"></script>
        <script>
            $(document).ready(function() {
...
<script language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/js/plugin/15502332.js"></script>
<noscript>
    <a href="http://www.51.la/?15502332" target="_blank"><img alt="我要啦免费统计" src="<%=request.getContextPath()%>/images/15502332.asp" style="border:none" /></a>
</noscript>
